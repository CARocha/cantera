...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TiempoComida'
        db.create_table('diversidad_alimentaria_tiempocomida', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tiempos', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medios.Encuesta'])),
        ))
        db.send_create_signal('diversidad_alimentaria', ['TiempoComida'])


    def backwards(self, orm):
        # Deleting model 'TiempoComida'
        db.delete_table('diversidad_alimentaria_tiempocomida')
    ...
    models = {
        ...
        'diversidad_alimentaria.tiempocomida': {
            'Meta': {'object_name': 'TiempoComida'},
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['medios.Encuesta']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tiempos': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'lugar.comarca': {
