...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UsoTecnologia.hortaliza'
        db.add_column('tecnologia_usotecnologia', 'hortaliza',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UsoTecnologia.hortaliza'
        db.delete_column('tecnologia_usotecnologia', 'hortaliza')
    ...
    models = {
        ...
        'tecnologia.usotecnologia': {
            ...
            'hortaliza': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
