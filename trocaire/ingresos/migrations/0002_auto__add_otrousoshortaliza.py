...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OtroUsosHortaliza'
        db.create_table('ingresos_otrousoshortaliza', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hortaliza', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ingresos.CIHortalizas'])),
            ('cuanto_consumio', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('cuanto_cs', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('cuanto_cambio', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('cuanto_regalo', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('valor_regalo', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('obtuvo_trueque', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('valor_trueque', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('ahorro_trueque', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medios.Encuesta'])),
        ))
        db.send_create_signal('ingresos', ['OtroUsosHortaliza'])


    def backwards(self, orm):
        # Deleting model 'OtroUsosHortaliza'
        db.delete_table('ingresos_otrousoshortaliza')
    ...
    models = {
        ...
        'ingresos.ihortalizas': {
            ...
            'cuanto': ('django.db.models.fields.FloatField', [], {}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['medios.Encuesta']"}),
            'equivalencias': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'ingresos.otrousoshortaliza': {
            'Meta': {'object_name': 'OtroUsosHortaliza'},
            'ahorro_trueque': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'cuanto_cambio': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'cuanto_consumio': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'cuanto_cs': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'cuanto_regalo': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['medios.Encuesta']"}),
            'hortaliza': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ingresos.CIHortalizas']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'obtuvo_trueque': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'valor_regalo': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'valor_trueque': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'})
        },
        'ingresos.pprocesado': {
        ...
        'ingresos.principalesfuentes': {
            ...
            'fuentes_ap': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'fuentes_no_ap': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        'ingresos.totalingreso': {
            'Meta': {'object_name': 'TotalIngreso'},
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['medios.Encuesta']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'total': ('django.db.models.fields.FloatField', [], {}),
            'total_ap': ('django.db.models.fields.FloatField', [], {})
        },
