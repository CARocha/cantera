...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ingresos_principalesfuentes', (
            ...
            ('fuentes_ap', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('fuentes_no_ap', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        ...
        db.create_table('ingresos_cultivosiperiodos', (
            ...
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medios.Encuesta'])),
            ('total_postrera', self.gf('django.db.models.fields.FloatField')()),
            ('total_apante', self.gf('django.db.models.fields.FloatField')()),
            ('total_primera', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.create_table('ingresos_ihortalizas', (
            ...
            ('cuanto', self.gf('django.db.models.fields.FloatField')()),
            ('precio', self.gf('django.db.models.fields.FloatField')()),
            ('equivalencias', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medios.Encuesta'])),
            ('total', self.gf('django.db.models.fields.FloatField')()),
        ))
        ...
        db.create_table('ingresos_lactios', (
            ...
            ('cantidad_invi', self.gf('django.db.models.fields.FloatField')()),
            ('verano_precio', self.gf('django.db.models.fields.FloatField')()),
            ('cantidad_vera', self.gf('django.db.models.fields.FloatField')()),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medios.Encuesta'])),
            ('total', self.gf('django.db.models.fields.FloatField')()),
            ('total_verano', self.gf('django.db.models.fields.FloatField')()),
            ('total_invierno', self.gf('django.db.models.fields.FloatField')()),
        ))
        ...
        # Adding model 'TotalIngreso'
        db.create_table('ingresos_totalingreso', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medios.Encuesta'], unique=True)),
            ('total', self.gf('django.db.models.fields.FloatField')()),
            ('total_ap', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('ingresos', ['TotalIngreso'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'TotalIngreso'
        db.delete_table('ingresos_totalingreso')
