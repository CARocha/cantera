...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('medios_contraparte', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('medios', ['Contraparte'])
        ...
        db.create_table('medios_encuesta', (
            ...
            ('comarca', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['lugar.Comarca'])),
            ...
            ('contraparte', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medios.Contraparte'], null=True, blank=True)),
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('sexo_jefe', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('credito', self.gf('django.db.models.fields.IntegerField')(default=2)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('medios_contraparte')
