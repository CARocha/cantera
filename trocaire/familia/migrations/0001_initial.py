...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('familia_composicion', (
            ...
            ('dependientes', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        ...
        db.create_table('familia_escolaridad', (
            ...
            ('conyugue', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medios.Encuesta'])),
        ))
    ...
    models = {
        ...
        'familia.escolaridad': {
            ...
            'conyugue': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['medios.Encuesta']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'lugar.comarca': {
