...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Huerto'
        db.create_table('crisis_alimentaria_huerto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('periodo', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('epoca', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medios.Encuesta'])),
        ))
        db.send_create_signal('crisis_alimentaria', ['Huerto'])


    def backwards(self, orm):
        # Deleting model 'Huerto'
        db.delete_table('crisis_alimentaria_huerto')
    ...
    models = {
        ...
        'crisis_alimentaria.huerto': {
            'Meta': {'object_name': 'Huerto'},
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['medios.Encuesta']"}),
            'epoca': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'periodo': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'lugar.comarca': {
