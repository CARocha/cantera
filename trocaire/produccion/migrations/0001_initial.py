...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('produccion_cultivosperiodos', (
            ...
            ('primera', self.gf('django.db.models.fields.FloatField')()),
            ('postrera', self.gf('django.db.models.fields.FloatField')()),
            ('apante', self.gf('django.db.models.fields.FloatField')()),
            ('p_primera', self.gf('django.db.models.fields.FloatField')()),
            ('p_postrera', self.gf('django.db.models.fields.FloatField')()),
            ('p_apante', self.gf('django.db.models.fields.FloatField')()),
            ...
            ('productividad', self.gf('django.db.models.fields.FloatField')()),
        ))
        ...
        db.create_table('produccion_consumodiario', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('maiz', self.gf('django.db.models.fields.FloatField')()),
            ('frijol', self.gf('django.db.models.fields.FloatField')()),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medios.Encuesta'])),
        ))
        ...
        db.create_table('produccion_arboles', (
            ...
            ('otra', self.gf('django.db.models.fields.FloatField')()),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medios.Encuesta'])),
        ))
