...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GanadoMayor.frecuencia'
        db.add_column('produccion_ganadomayor', 'frecuencia',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ConsumoDiario.arroz'
        db.add_column('produccion_consumodiario', 'arroz',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GanadoMayor.frecuencia'
        db.delete_column('produccion_ganadomayor', 'frecuencia')

        # Deleting field 'ConsumoDiario.arroz'
        db.delete_column('produccion_consumodiario', 'arroz')
    ...
    models = {
        ...
        'produccion.consumodiario': {
            ...
            'arroz': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['medios.Encuesta']"}),
